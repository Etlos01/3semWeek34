...
public class EmployeeFacade {
   ...
   private static EmployeeFacade facade = EmployeeFacade.getFacadeExample(emf);
    ...
    Employee b1 = facade.creatEmployee("Hans", "Østerbro", 5000);
    Employee b2 = facade.creatEmployee("Andreas", "Vesterbro", 6000);
    //Find Employee by ID
    ...
    System.out.println("employee2: "+facade.findEmployee(b2.getName()).getAdress() + b2.getName());
    //Find all Employees
